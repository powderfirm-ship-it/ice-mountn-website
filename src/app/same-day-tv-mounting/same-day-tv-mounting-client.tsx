              ...
              <Card>
                <CardContent className="p-6">
                  ...
                  <p className="text-gray-600 text-sm">
                    We begin with a quick assessment of your space, wall type, and device compatibility to ensure a clean, secure same-day TV mounting
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <Accordion type="single" collapsible className="space-y-3">
              ...
              <AccordionItem value="q5" className="bg-white border border-gray-200 rounded-lg px-6">
                <AccordionTrigger className="text-left font-semibold text-gray-900">
                  How do you ensure same-day availability and quality?
                </AccordionTrigger>
                <AccordionContent className="text-gray-600 pb-4 text-sm">
                  Our same-day service maintains the same quality standards as scheduled appointments. We have dedicated
                  technicians and equipment ready for urgent installations while ensuring professional results.
                </AccordionContent>
              </AccordionItem>
            </Accordion>
          </div>
